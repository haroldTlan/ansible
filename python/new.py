...
def docker_init(master):
    ...
    #work = run_adhoc("192.168.2.149", key)
    #results = run_playbook("yml/docker_join.yml")
    #import pdb
    #pdb.set_trace()
    #for worker in results:
    #    if worker['task'] == 'join' and "Error" not in worker['result']._result['stdout']:
    #        print "success"
    #    else:
    #        print worker['result']._result['stdout']
